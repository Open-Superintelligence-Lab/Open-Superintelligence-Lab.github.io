      ...
      <main id="research-projects" className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Video Models Zero-Shot Project */}
            <Link 
              href="/blog/video-models-zero-shot"
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                  Google DeepMind&apos;s Veo 3 demonstrates emergent zero-shot capabilities for visual reasoning, suggesting video models may follow LLMs toward general-purpose foundation models
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500">Google DeepMind</span>
