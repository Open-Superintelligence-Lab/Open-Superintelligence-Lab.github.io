          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="relative">
              <div className="flex flex-col items-center">
                <div className="relative">
                  <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black mb-2 bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 bg-clip-text text-transparent leading-tight">
                    {language === 'en' ? 'Open' : '开放'}
                  </h1>
                  {/* Glow effect for Open */}
                  <div className="absolute inset-0 text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black bg-gradient-to-r from-green-400/20 via-emerald-400/20 to-teal-400/20 bg-clip-text text-transparent blur-sm leading-tight">
                    {language === 'en' ? 'Open' : '开放'}
                  </div>
                </div>
                ...
                <div className="relative">
                  {language === 'en' ? (
                    <div className="text-center">
                      <h2 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-2 bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent leading-tight">
                        Superintelligence
                      </h2>
                      {/* Glow effect for Superintelligence */}
                      <div className="absolute inset-0 text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-cyan-400/20 bg-clip-text text-transparent blur-sm leading-tight">
                        Superintelligence
                      </div>
                      
                      <h3 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-8 bg-gradient-to-r from-cyan-400 via-purple-400 to-blue-400 bg-clip-text text-transparent leading-tight">
                        Lab
                      </h3>
                      {/* Glow effect for Lab */}
                      <div className="absolute inset-0 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black bg-gradient-to-r from-cyan-400/20 via-purple-400/20 to-blue-400/20 bg-clip-text text-transparent blur-sm leading-tight">
                        Lab
                      </div>
                    </div>
                  ) : (
