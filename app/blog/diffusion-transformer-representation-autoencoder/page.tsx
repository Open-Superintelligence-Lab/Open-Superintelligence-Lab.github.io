...
export default function DiffusionTransformerRAEProject() {
  ...
  useEffect(() => {
    const fetchMarkdownContent = async () => {
      try {
        const filename = language === 'zh' ? 'diffusion-transformer-rae-content-zh.md' : 'diffusion-transformer-rae-content.md';
        const response = await fetch(`/content/diffusion-transformer-representation-autoencoder/${filename}`);
        ...
        if (frontmatterMatch) {
          ...
          const heroData: HeroData = {
            title: "47x Faster Image & Video Generation Training",
                ...
                <div className="mb-8">
                  <div className="relative" style={{ paddingTop: '56.25%' }}>
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/P4NnRDlYKHM"
              ...
              <div className="bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-cyan-600/5 border-t border-white/10 px-8 sm:px-12 py-8">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=Check%20out%20this%20article%20on%2047x%20Faster%20Image%20Generation&url=https://opensuperintelligencelab.com/blog/diffusion-transformer-representation-autoencoder/" 
                       target="_blank" 
                       rel="noopener noreferrer"
                    ...
                    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://opensuperintelligencelab.com/blog/diffusion-transformer-representation-autoencoder/" 
                       target="_blank" 
                       rel="noopener noreferrer"
                       className="text-slate-400 hover:text-blue-400 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
