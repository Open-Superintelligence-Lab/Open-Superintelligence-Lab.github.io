...
export default function TinyRecursiveModelProject() {
  ...
  useEffect(() => {
    const fetchMarkdownContent = async () => {
      try {
        const response = await fetch(`/content/tiny-recursive-model/tiny-recursive-model-content.md`);
              ...
              <div className="bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-cyan-600/5 border-t border-white/10 px-8 sm:px-12 py-8">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=Check%20out%20the%20Tiny%20Recursive%20Model%20article&url=https://opensuperintelligencelab.com/blog/tiny-recursive-model/"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://opensuperintelligencelab.com/blog/tiny-recursive-model/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-slate-400 hover:text-blue-400 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
