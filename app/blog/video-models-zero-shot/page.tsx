...
export default function VideoModelsZeroShotPage() {
  ...
  useEffect(() => {
    const fetchMarkdownContent = async () => {
      try {
        const filename = language === 'zh' ? 'video-models-zero-shot-content-zh.md' : 'video-models-zero-shot-content.md';
        const response = await fetch(`/content/video-models-zero-shot/${filename}`);
        ...
        if (frontmatterMatch) {
          ...
          const heroData: HeroData = {
            ...
            subtitle: "🎬 From Vision to Reasoning - Veo 3's Emergent Capabilities",
            ...
            <div className="relative">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium mb-8 leading-tight">
                <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
                  {heroData?.title || 'Video Models are Zero-Shot Learners and Reasoners'}
                </span>
              </h1>
              <div className="text-lg md:text-xl text-slate-400 mb-8">
                {heroData?.subtitle || '🎬 From Vision to Reasoning - Veo 3\'s Emergent Capabilities'}
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-cyan-600/5 border-t border-white/10 px-8 sm:px-12 py-8">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=Video%20Models%20are%20Zero-Shot%20Learners%20and%20Reasoners%20-%20Veo%203%27s%20emergent%20capabilities%20for%20visual%20reasoning%20%E2%9A%A1%EF%B8%8F&url=https://opensuperintelligencelab.com/blog/video-models-zero-shot/" 
                       target="_blank" 
                    ...
                    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://opensuperintelligencelab.com/blog/video-models-zero-shot/" 
                       target="_blank" 
                       rel="noopener noreferrer"
                       className="text-slate-400 hover:text-blue-400 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
